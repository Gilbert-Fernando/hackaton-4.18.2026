...
- `models/asl_model.h5` — trained model (stored via `joblib`, name matches your skeleton)
- `models/label_encoder.pkl` — label encoder for mapping class index -> label
- `src/hand_tracking.py` — MediaPipe hand tracking + feature extraction
...
- Keep labels small for MVP (e.g. 5 letters + 5 phrases), then expand.
